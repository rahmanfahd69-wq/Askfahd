...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* ── Mobile: top header ── */}
      <header className="md:hidden fixed top-0 inset-x-0 z-40 h-14 bg-[#050505]/95 backdrop-blur-md border-b border-[rgba(255,255,255,0.07)] flex items-center justify-between px-4">
